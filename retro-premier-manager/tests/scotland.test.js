...
test('starting a new game as a Scottish club sets up all four divisions correctly', () => {
  ...
  for (const division of ['PL', 'CH', 'SPL', 'SCH']) {
  ...
  assert.equal(divisionsPlaying.size, 4)
